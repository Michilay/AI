...
public class EightPuzzle implements Comparable{
    ...
    private ArrayList<EightPuzzle> answer = new ArrayList<EightPuzzle>();    //动态数组保存最终路径
    public int[] getNum() {
        return num;
    }
    ...
    public void init(EightPuzzle target){
        ...
        this.setf(this.getDepth()+this.geth());//返回当前状态的估计值
    }
